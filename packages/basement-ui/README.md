...
- `src/components/` — Reusable UI component styles (Button, Tabs, Toggle, Text Input, Form, Graph, Tag, Status Chip, Progress, Player, Avatar, Dropdown, Prompt, Alert, Table, Timeline, Sidebar)
