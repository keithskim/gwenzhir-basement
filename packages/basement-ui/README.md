...
- `src/components/` — Reusable UI component styles (Button, Tabs, Toggle, Text Input, Form, Graph, Tag, Status Chip, Pairs, Content Block, Progress, Spinner, Player, Avatar, Menu, Dropdown, Tooltip, Datetime, Sidebar, Prompt, Alert, Table, Timeline)
