...
**Image** — `img.img-placeholder`, or `.img-placeholder` around an image, turns a picture into a faint high-contrast grayscale on Gray XL. For stand-in photos in prototypes. With no picture, the frame is that pale gray. The reference shows the treatment on photographs under Graphics.
