...
- **Components** — Button (Default, Subtle, Accent, Ghost, Icon + disabled state; 2XS / XS / S), Form (Input, Label, Textarea, Checkbox, Radio, Switch), Tag (2XS / XS / S / M), Avatar, Dropdown, Table (header, sortable columns, striped rows), Alert (Neutral, Affirm, Warn, Destructive)
