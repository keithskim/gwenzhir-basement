...
- **Components** — Button (Default, Accent, Ghost, Icon + disabled state; S / M / L), Form (Input, Label, Textarea, Checkbox, Radio, Switch), Tag, Avatar, Dropdown, Alert (Neutral, Affirm, Warn, Destructive)
