...
- **Components** — Button (Default, Subtle, Accent, Ghost, Icon + disabled state; S / M / L), Form (Input, Label, Textarea, Checkbox, Radio, Switch), Tag, Avatar, Dropdown, Table (header, sortable columns, striped rows), Alert (Neutral, Affirm, Warn, Destructive)
